...
if(isset($_POST['hapusprodukpesanan'])){
    $iddetail = $_POST['id_detailpesanan']; //detail pesanan
...
if(isset($_POST['editproduk'])){
    ...
    "UPDATE produk SET nama_produk='$np', deskripsi='$deskripsi', harga='$harga' WHERE id_produk='$id_produk'");
...
if (isset($_POST['hapusproduk'])){
    ...
    $hapusbarang = mysqli_query($koneksi,
    "DELETE FROM produk WHERE id_produk= '$idpr'");
...
if (isset($_POST['hapuspesanan'])){
    $idps = $_POST['id_pesanan'];

    $hapuspesanan = mysqli_query($koneksi,
    "DELETE FROM pesanan WHERE id_pesanan= '$idps'");
