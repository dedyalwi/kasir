                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $brg['qty'] ?></td>
                                            <td><?= $brg['tgl_masuk'] ?></td>
                                            <td><button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?= $id_masuk;?>">Edit</button> <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?= $id_masuk;?>">Delete</button></td>
                                        </tr>
                                        <?php $i ++; ?>
                                        <?php endforeach; ?>
                                    </tbody>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Dedy Alwi 2024</div>
                        </div>
                    </div>
                </footer>
            </div>
